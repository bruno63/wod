...
<xsl:stylesheet 
  ...
  xmlns:bk="http://www.bkaiser.com/2017/ns/sise" version="1.0">
...
<!--       <fo:static-content flow-name="footer">
 ...
 <!--        <fo:block space-after="1em">23. SI-SE Fachtagung</fo:block>
        <fo:block font-size="2em" font-weight="bold" space-after="2em">Teilnahmebestätigung</fo:block>
        <fo:block font-weight="bold" space-after="1.5em">
          <xsl:value-of select="@name"/>
        </fo:block>
        <fo:block space-after="1em">hat an der folgenden Ausbildung teilgenommen:</fo:block>
          ...
          <fo:table-body>
            <fo:table-row >
              ...
              <fo:table-cell column-number="2" xsl:use-attribute-sets="cell">
                <fo:block>23. SI-SE Fachtagung</fo:block>
              </fo:table-cell>
            </fo:table-row>
            <fo:table-row>
              <fo:table-cell column-number="1" xsl:use-attribute-sets="cell">
            ...
            <fo:table-row>
              ...
              <fo:table-cell column-number="2" xsl:use-attribute-sets="cell">
                <fo:block>Mit DevOps zu schnellen, kontinuierlichen Software-Lieferungen</fo:block>
              </fo:table-cell>
            </fo:table-row>
            <fo:table-row>
              <fo:table-cell column-number="1" xsl:use-attribute-sets="cell">
              ...
              <fo:table-cell column-number="2" xsl:use-attribute-sets="cell">
                ...
                <fo:block>Aula der altenKantonsschule</fo:block>
                <fo:block>Rämistr. 59</fo:block>
